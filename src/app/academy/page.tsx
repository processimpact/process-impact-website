  ...
  return (
    <div className="container py-24">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-4xl font-bold text-center">Axoltol Academy</h1>
        <p className="mt-6 text-lg text-center text-muted-foreground">
          Offensive security training tuned for industrial control systems and focused on living-off-the-land techniques.
        </p>
